...
const translations = {
    en: {
        ...
        about: {
            ...
            description: "As a DevOps Engineer at Mono Bilişim, I specialize in managing complex infrastructure and implementing modern DevOps practices. My expertise spans across Linux systems, containerization technologies, and automation tools. I'm particularly skilled in managing Proxmox environments, implementing robust CI/CD pipelines, and optimizing infrastructure for maximum efficiency and scalability. My technical journey began with a strong foundation in computer engineering, which I'm currently pursuing at Üsküdar University and complementing with practical experience at 42 Ecole. This combination of theoretical knowledge and hands-on experience has enabled me to develop a comprehensive understanding of both traditional and cutting-edge technologies. I'm passionate about continuous learning and staying at the forefront of technology trends, particularly in cloud computing, infrastructure automation, and system optimization. My approach combines technical expertise with practical problem-solving skills to deliver efficient and scalable solutions."
        },
        education: {
    ...
    tr: {
        ...
        about: {
            title: "Hakkımda",
            name: "Ali Erdem Cerrah",
            description: "Mono Bilişim'de DevOps Mühendisi olarak, karmaşık altyapı yönetimi ve modern DevOps uygulamalarının implementasyonu konusunda uzmanlaşmış durumdayım. Uzmanlık alanım Linux sistemleri, konteynerizasyon teknolojileri ve otomasyon araçlarını kapsıyor. Özellikle Proxmox ortamlarının yönetimi, sağlam CI/CD pipeline'larının uygulanması ve altyapının maksimum verimlilik ve ölçeklenebilirlik için optimizasyonu konularında yetenekliyim. Teknik yolculuğum, şu anda Üsküdar Üniversitesi'nde devam ettiğim ve 42 Ecole'deki pratik deneyimle desteklediğim bilgisayar mühendisliği eğitimimle sağlam bir temel üzerine kurulu. Teorik bilgi ve pratik deneyimin bu kombinasyonu, hem geleneksel hem de en yeni teknolojiler hakkında kapsamlı bir anlayış geliştirmemi sağladı. Sürekli öğrenme ve özellikle bulut bilişim, altyapı otomasyonu ve sistem optimizasyonu konularında teknoloji trendlerinin ön saflarında kalma konusunda tutkulu bir yaklaşımım var. Yaklaşımım, verimli ve ölçeklenebilir çözümler sunmak için teknik uzmanlığı pratik problem çözme becerileriyle birleştiriyor."
        },
        education: {
